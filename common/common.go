...
// CreateTmpFile create a file to test the upload and download.
...
// ToCamelCase Convert to Big Hump format
...
// ToSnakeCase Convert to underlined format
...
// InSlice Determine if the string is in the list.
